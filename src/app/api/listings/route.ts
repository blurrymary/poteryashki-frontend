  ...
  try {
    ...
    const { error: insertError } = await supabaseAdmin
      ...
      .insert({
        ...
        type,
        animal,
        breed: ((formData.get("breed") as string) === "__other" ? null : (formData.get("breed") as string)) || null,
        color: ((formData.get("color") as string) === "__other" ? null : (formData.get("color") as string)) || null,
